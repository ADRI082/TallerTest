...
namespace Taller
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ConcesionarioDBContext>(opts => 
            opts.UseMySql(Configuration["ConnectionString:TallerDB"]));

            //Aquí las inyecciones: Interfaz - Clase
            services.AddScoped<IUsuarioBL, UsuarioBL>();
            services.AddScoped<IJefeBL, JefeBL>();
            services.AddScoped<IUsuarioRepository, UsuarioRepository>();
            services.AddScoped<IJefeRepository, JefeRepository>();
